  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        <h2>Vous devez rester chez vous pendant 14 jours immédiatement après votre retour au Canada.</h2>
        <p>
        ...
        <ol>
          ...
          <li>
            <AnchorLink to="/autoevaluation/r5#monitor-your-health">Surveillez votre santé </AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R5 = () => <ResultsTemplate lang="fr" resultsContent={resultsContent} />
