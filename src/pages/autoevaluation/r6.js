  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        <h2>
          Vous devez rester à la maison pendant 14 jours parce que vous avez
          été en contact étroit avec une personne ayant voyagé récemment, ayant reçu un
          résultat positif à la COVID-19 ou présentant de nouveaux symptômes respiratoires.
        </h2>
        <p>
        ...
        <ol>
          <li>
            <AnchorLink to="/autoevaluation/r6#stay-at-home">Restez à la maison pendant 14 jours </AnchorLink>
          </li>
          <li>
            <AnchorLink to="/autoevaluation/r6#monitor-your-health">Surveillez votre santé</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
    ...
    <div className="ontario-row ontario-results__content" id="stay-at-home">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <p>
          Vous pourriez être porteur du virus sans le savoir. Restez à la maison pour que les autres membres de votre
          communauté ne tombent pas malades.
        </p>
...
const R6 = () => <ResultsTemplate lang="fr" resultsContent={resultsContent} />
