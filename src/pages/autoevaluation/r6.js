  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        <h2>
          Sur la base de vos réponses, nous vous recommandons de <strong>rester à la maison pendant 14 jours</strong> parce que vous avez été en contact physique
          étroit avec une personne présentant des symptômes de la COVID-19 ou qui a voyagé récemment.
        </h2>
        <p>
    ...
    <div className="ontario-row ontario-results__content" id="monitor-your-health">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <ul>
          ...
          <li>
            êtes de nouveau en contact physique étroit avec une personne qui a de la difficulté à respirer, qui fait de la fièvre ou qui présente une nouvelle toux
          </li>
        </ul>
